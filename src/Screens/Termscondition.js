  ...
  return (
    <>
      <div className="container text-light mt-5">
        ...
        <div className="segoe">
          <h6 className="text-center mt-4 mb-4">KFC TERMS OF USE</h6>
          <p>
          ...
          <h6 className="mt-4">NO WARRANTY/LIMITATION ON LIABILITY</h6>
          <p>
          ...
          <h6 className="mt-4">COMMUNICATING WITH KFC</h6>
          <p>
          ...
          <h6 className="mt-4">KFC PROPERTY</h6>
          <p>
          ...
          <h6 className="mt-4">USER-SUBMITTED CONTENT</h6>
          <p>
          ...
          <p>
            ...
            reason whatsoever subject to following terms: You hereby grant to
            KFC a limited, non-exclusive, sub-licensable, worldwide, fully-paid,
            royalty free license to use, modify, publicly perform, publicly
            display, reproduce, and distribute Submitted Content. This license
            includes the right to host, index, cache, distribute, and tag any
            Submitted Content, as well as the right to sublicense Submitted
            Content to third parties, including other users, for use on other
            platforms, such as for use on mobile phones, in video or music
          ...
          <p>
            ...
            displayed, published or posted by you to the Site. You agree that
            your Submitted Content is gratuitous and made without restriction,
            and will not place KFC under any obligation. You agree that KFC is
            free to disclose the ideas contained in the Submission, including,
            for example, ingredient or menu item suggestions, on a
            ...
            its employees, or obtained from sources other than you. Your posting
            of Submitted Content is further subject to the following posting
            rules:
          </p>
          ...
          <h6 className="mt-4">ONLINE PURCHASES</h6>
          <p>
          ...
          <h6 className="mt-4">WEB SITE ACCESS</h6>
          <p>
            ...
            of Use. In order to access some features of the Site, you will have
            ...
            such unauthorized use. You agree not to use or launch any automated
            system, including without limitation, "robots," "spiders," "offline
            readers," etc., that accesses the Site in a manner that sends more
            request messages to the KFC servers in a given period of time than a
            human can reasonably produce in the same period by using a
            conventional online Web browser. Notwithstanding the foregoing, KFC
            ...
            not caches or archives of such materials. KFC reserves the right to
            revoke these exceptions either generally or in specific cases. You
            ...
            communication systems provided by the Site for any commercial
            solicitation purposes. You agree not to solicit, for commercial
            purposes, any users of the Site with respect to their User Submitted
            Content.
          </p>

          <h6 className="mt-4">INDEMNIFICATION</h6>
          <p>
          ...
          <h6 className="mt-4">HYPER-LINKS</h6>
          <p>
          ...
          <h6 className="mt-4">TEXT MESSAGING NOTICE</h6>
          <p>
          ...
          <h6 className="mt-4">MISCELLANEOUS</h6>
          <p>
            ...
            the authority to obligate or bind the other. The failure of KFC to
            ...
            be invalid or unenforceable, the parties nevertheless agree that the
            court should endeavor to give effect to the parties' original
            intentions as reflected in the provision, and the other provisions
            of this Agreement shall remain in full force and effect. Software
            that may be available in connection with this site is subject to
            United States export controls. No software may be downloaded from
            this site or otherwise exported or re-exported in violation of U.S.
            export laws. Downloading or using the software is at your sole risk.
            The failure of KFC to comply with this Agreement because of an act
            of God, war, fire, riot, terrorism, earthquake, actions of federal,
            state or local governmental authorities or for any other reason
            beyond the reasonable control of KFC, shall not be deemed a breach
            of this Agreement. If KFC fails to act with respect to your breach
            or anyone else's breach on any occasion, KFC is not waiving its
            right to act with respect to future or similar breaches. The
            headings in this Agreement are for your convenience and reference.
            These headings do not limit or affect this Agreement. If any
            provision of these terms of use shall be unlawful, void or for any
          ...
          <h6 className="mt-4">ARBITRATION AND DISPUTE RESOLUTION</h6>
          <p>
            ...
            CONTROVERSY ARBITRATED IN ACCORDANCE WITH THESE TERMS. BY USING THE
            KFC SITE OR SUBMITTING CONTENT, YOU AGREE THAT TO THE EXTENT
            PERMITTED BY APPLICABLE LAW: (1) ANY AND ALL DISPUTES, CLAIMS AND
            CAUSES OF ACTION ARISING OUT OF OR CONNECTED WITH YOUR USE OF THE
            KFC SITE OR YOUR SUBMITTED CONTENT WILL BE RESOLVED INDIVIDUALLY
          ...
          <h6 className="mt-4">GOVERNING LAW AND JURISDICTION</h6>
          <p>
